...
Pi 作者在 2025 年 11 月的架构长文中把最小系统提示、最小工具集和可检查 Session 作为正面设计，并把“无内建 Todo、Plan Mode、MCP、后台 Shell 与 Subagent”列为当时的明确取舍 [@zechner2025piminimal]。这些表述记录的是当时的核心立场，不排除后续仓库或 Extension 已构造相应能力；本章因此始终区分“核心默认不内建”与“扩展无法实现”。
...
作为官方延伸阅读，Pi 作者的架构长文集中解释了这种“有意见的极简”从何而来，以及为何强调最小工具面、可检查模型交互和干净 Session [@zechner2025piminimal]。其中列出的“不内建”项应按 2025 年 11 月的设计快照理解，当前能力仍以本章固定源码和所选 Extension 为准。
